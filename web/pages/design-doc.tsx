            ...
            <div>
                ...
                <div className="container mx-auto px-[0.2%]">
                    ...
                    <div className="container mx-auto px-[7%]">
                        <p><strong>Repository URL:</strong> <a href="https://github.com/ethanbonsall/Pediatric-Blue-Book">https://github.com/ethanbonsall/Pediatric-Blue-Book</a></p>
                        <p>The complete source code is archived in this GitHub repository. It contains all application code, configuration files, tests, and documentation needed to build and deploy the system.</p>
                        <br></br>
                    </div>
                    <h3 className="font-semibold text-xl mb-2">2.2: README: How to build the system</h3>
                    <div className="container mx-auto px-[7%]">
                        <h4><strong>Tech Stack:</strong></h4>
                        <ul>
                            <li><strong>Framework:</strong> Next.js</li>
                            <li><strong>Language:</strong> TypeScript</li>
                            <li><strong>UI:</strong> React, Tailwind CSS, shadcn/ui</li>
                            <li><strong>Backend:</strong> Supabase</li>
                            <li><strong>Testing:</strong> Jest</li>
                            <li><strong>Deployment:</strong> Vercel</li>
                            <li><strong>Domain:</strong> Namecheap</li>
                        </ul>
                        <br></br>
                        <h4><strong>Running the project locally</strong></h4>
                        <ul>
                            <li>Clone repository: <code>git clone https://github.com/ethanbonsall/Pediatric-Blue-Book.git</code></li>
                            <li>Navigate to web directory: <code>cd Pediatric-Blue-Book/web</code></li>
                            <li>Install dependencies: <code>npm install</code></li>
                            <li>Create <code>.env.local</code> file with Supabase keys inside /web </li>
                        ...
                        <p>Tests are written with Jest and stored in <code>__tests__/</code>.</p>
                        <ul>
                            <li>Run tests: <code>npm test</code></li>
                            <li>Watch mode: <code>npm run test:watch</code></li>
                        </ul>
                    </div>
                    <br></br>
                    ...
                    <div className="container mx-auto px-[7%]">
                      ...
                      <ul>
                            ...
                            <li><strong>pages/_app.tsx</strong> wraps entire app, imports <strong>components/context/themecontext.tsx</strong> for global state</li>
                            <li><strong>components/ui/</strong> components import <strong>components/lib/types.ts</strong> for TypeScript types</li>
                            <li><strong>All components</strong> use <strong>components/lib/supabase.tsx</strong> for database access</li>
                            <li><strong>components/ui/</strong> use <strong>components/lib/utils.ts</strong> for helper functions</li>
                            <li><strong>app/api/delete-user/route.ts</strong> handles backend API logic</li>
                            <li><strong>__tests__/</strong> test files import components and run Jest tests</li>
                            <li><strong>All .tsx/.ts files</strong> use TypeScript for type safety</li>
                ...
                <div className="container mx-auto px-[5%]">
                    ...
                    <div className="container mx-auto px-[7%]">
                        ...
                        <br></br>
                        <h4><strong>Tables:nutrient needs</strong></h4>
                        ...
                        <br></br>
                        <h4><strong>Tables:ingredients</strong></h4>
                ...
                <div className="container mx-auto px-[5%]">
                    ...
                    <div className="container mx-auto px-[7%]">
                        <ul>
                            <li><strong>TypeScript:</strong> compile-time type safety, better IDE support, clearer refactoring and documentation.</li>
                            <li><strong>Next.js:</strong> team familiarity, SSR/SSG for performance/SEO, built-in API routes, seamless Vercel deploys.</li>
                            <li><strong>Supabase:</strong> PostgreSQL (relational queries), row-level security for HIPAA, open-source/self-host option, SQL familiarity.</li>
                            <li><strong>Vercel:</strong> team experience, automatic SSL & CI/CD, Next.js-optimized, free tier for launch.</li>
                            <li><strong>Testing:</strong> Jest</li>
                            <li><strong>Tailwind CSS:</strong> fast development with utility classes, team expertise, small purged bundles and consistent design.</li>
                        </ul>
                    </div>
                    <br></br>
                    <h3 className="font-semibold text-xl mb-2">4.2: Architechture</h3>
                    <div className="container mx-auto px-[7%]">
                        <p><strong>Three-layer separation </strong>(Presentation / Business Logic / Data Access) for defense-in-depth, clearer code, and HIPAA-compliant data isolation.</p>
                    </div>
                    <br></br>
                    <h3 className="font-semibold text-xl mb-2">4.3: Data model</h3>
                    <div className="container mx-auto px-[7%]">
                        <p><strong>Soft delete (is_active)</strong>to meet retention/audit requirements and allow restores.</p>
                        <p><strong>JSONB for input/output</strong>to support evolving calculation schemas without migrations and keep good performance.</p>
                        <p><strong>Separate calculations table</strong>to preserve immutable history, enable comparisons and auditing.</p>
                    </div>
                    <br></br>
                    <h3 className="font-semibold text-xl mb-2">4.4: Dependencies (core)</h3>
                    <div className="container mx-auto px-[7%]">
