...
"
                  ...
                  <li>To launch the site on your machine:
                  <pre className="whitespace-pre-wrap bg-gray-100 rounded-md p-3 text-sm font-mono">
                    npm run dev
                    </pre>
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>The live website is hosted on Vercel. The client will receive full administrative access to the Vercel project.
</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-xl mb-2">
                System Description and Host
